...
$("#add-billing-field").on("click", function () {
   var pcfmenewPanel = pcfmecheckoutfield.clone();
	...
	pcfmenewPanel.find(".checkout_field_width_new").select2({width: "250px","disable_search": true});
	pcfmenewPanel.find(".checkout_field_visibility_new").select2({width: "250px","disable_search": true});
	pcfmenewPanel.find(".checkout_field_conditional_showhide_new").select2({width: "70px","disable_search": true});
	pcfmenewPanel.find(".checkout_field_conditional_parentfield_new").select2({width: "170px"});
	pcfmenewPanel.find(".checkout_field_type_new").select2({width: "250px"});
	...
	pcfmenewPanel.find(".checkout_field_products_new").select2({
  		   ajax: {
